...
#[derive(Debug)]
pub struct UserRepo(Arc<Mutex<DatabaseConnection>>);
...
impl UserRepo {
    ...
    pub async fn create(
        ...
        let k = a.insert(&self.get_connection()).await;
    ...
    pub async fn get_many(
        ...
        let v = User::find().all(&self.get_connection()).await;
    ...
    pub async fn get_by_id(
        ...
        let res = User::find_by_id(id).one(&self.get_connection()).await;
    ...
    pub async fn delete_by_id(
        ...
        let a =
            User::delete(res.into_active_model()).exec(&self.get_connection()).await;
